...
class MBertTokenizer:
    def __init__(self, model_name='/root/bert-base-multilingual-cased'):
...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='../data/MLMDNews/train.label.jsonl', help='File to deal with')
    parser.add_argument('--dataset', type=str, default='MLMDNews', help='dataset name')
