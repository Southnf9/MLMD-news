...
def main():
    ...
    parser.add_argument("--bert_model", default='/root/bert-base-multilingual-cased', type=str)

    parser.add_argument("--do_lower_case", action='store_true')
    parser.add_argument("--cache_dir", default="./bert_cache", type=str)

    parser.add_argument("--data", type=str, default='./data/MLMDNews/test.label.jsonl')

    parser.add_argument("--align_matrix", type=str)
    parser.add_argument("--layers", type=str, default='9:13')
    parser.add_argument("--batch_size", default=100, type=int)

    parser.add_argument("--output", type=str, default='./bert_features_MLMDNews/')
